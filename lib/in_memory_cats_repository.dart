...
class InMemoryCatsRepository implements CatsRepository {
  ...
  @override
  Future<List<CatSanctuary>> search(String query) async {
    return _catsData
        .where((element) => element.title.contains(query))
        .toList();
  }
  final List<CatSanctuary> _catsData = const [
    CatSanctuary(
      id: '1',
      title: 'Tobby',
      description:
    ...
    CatSanctuary(
      ...
      title: 'Bengal Cat',
      description:
      'Lady and the Tramp is a 1955 American animated musical romance film produced by Walt Disney and released by Buena Vista Film Distribution.',
      imageUrl:
